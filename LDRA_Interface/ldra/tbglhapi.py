...
class tbglhapi(ldra_application):
    def __init__(self,toolsuite,workarea):
        self.logger = logging.getLogger('tbglhapi')
        self.executable = "tbglhapi"
        self.exit_codes = {
            0:"Success",
        }

        #optional list of files/extensions.  These will be searched for after execution and returned as part of the result
        self.results_files = [".txt"]
        
        super(tbglhapi,self).__init__(toolsuite,workarea)
