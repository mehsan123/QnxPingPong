...
def main():
    try:
        ...
        publish_result = rp.run(args.LDRA, "-annotated_code_report",
                                                        "-exclude_report",
                                                        "-guidelinecompliance_report",
                                                        "-hismetrics_report",
                                                        "-functioncoverage_report",
                                                        "-callcoveragereport",
                                                        "-controlcoupling_report",
                                                        "-datacoupling_report",
                                                        "-security_report",
                                                        "-tbpublish", 
                                                        tbpublish_dir=args.PUBLISH)
        if publish_result:
